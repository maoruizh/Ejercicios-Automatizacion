...
public class Advantage {
    ...
    public void createUser(ChromeDriver driver) throws InterruptedException {
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        driver.findElement(By.name("usernameRegisterPage")).sendKeys("Maoruizh2311119"); // si es para mostrar la prueba a camilo usar Maoruizh22
    ...
    public void MasterCreditNoExist(ChromeDriver driver) throws InterruptedException {
