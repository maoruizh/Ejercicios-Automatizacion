...
public class CreateUserPage {
    ...
    public static final Target BTN_USER = Target.the("Boton menu del usuario").located(By.xpath("(//span[contains(text(),'Maoruizh3444444')])[2]")); //este selector creo que se puede cambiar por el primero de todos, verificar
    ...
    public static final Target BTN_SAVE = Target.the("Guardar cambios").located(By.id("save_btnundefined"));
    public static final Target BTN_CREATE_USER_MESSAGE = Target.the("valida el nombre del usuario creado").located(By.xpath("(//span[contains(text(),'Maoruizh3444444')])[2]"));
