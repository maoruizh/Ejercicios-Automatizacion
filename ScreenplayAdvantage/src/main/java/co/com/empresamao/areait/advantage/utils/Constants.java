...
public class Constants {
    ...
    public static final String CREATE_SUCCESSFULLY_MESSAGE = "Maoruizh53332"; //siempre que se corra la tarea de creacion de usuario se debe cambiar este usuario
